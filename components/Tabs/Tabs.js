class TabLink {
  constructor(tabElement){
    ...
    if(this.tabData === "all"){
      ...
      // this.cards = ;
      this.cards = document.querySelectorAll('this.tabData'); //Check syntax of this.tabData within here!!!
      // console.log(this.cards);
    }
    // <- Delete this comment block when you work on the if statement
  ...
  selectTab(){
    ...
    const tabs = document.querySelectorAll('.tab'); //return NodeList of all tab class
    ...
    // const cards = ;
    const cards = document.querySelectorAll('.card'); //return NodeList with all card class
